...
from navigation.localfeature.lcore.hal import *
from navigation.localfeature.model.superpoint.superpointfrontend import SuperPointFrontend
import numpy as np
...
class CModel(CVisualLocalizationCore):
    ...
    def Open(self, gpu_flag, args_mode):
        ...
        self.__oSPPFrontend = SuperPointFrontend(weights_path="./navigation/localfeature/model/superpoint/checkpoints/checkpoint.pth",
